...
const liquidLight = {
  ...
  accent: 'linear-gradient(135deg, #8b5cf6 0%, #ec4899 50%, #f43f5e 100%)',
  accentText: '#ffffff',
  headerBg: 'rgba(255, 255, 255, .82)',
  sidebarBg: 'rgba(248, 252, 255, .8)',
  border: 'rgba(120, 160, 210, .15)',
  bubbleIn: 'rgba(255, 255, 255, .92)',
  bubbleOut: 'linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%)',
...
const midnightBlue = {
  ...
  bubbleOut: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)',
...
const aurora = {
  ...
  accent: 'linear-gradient(135deg, #f472b6 0%, #ec4899 50%, #db2777 100%)',
  accentText: '#ffffff',
  headerBg: 'rgba(35, 28, 72, .86)',
  sidebarBg: 'rgba(28, 22, 60, .86)',
  border: 'rgba(140, 90, 220, .1)',
  bubbleIn: 'rgba(48, 38, 88, .82)',
  bubbleOut: 'linear-gradient(135deg, #f472b6 0%, #db2777 100%)',
...
const forestGreen = {
  ...
  accent: 'linear-gradient(135deg, #22c55e 0%, #16a34a 50%, #15803d 100%)',
  accentText: '#ffffff',
  headerBg: 'rgba(18, 42, 36, .86)',
  sidebarBg: 'rgba(14, 32, 28, .86)',
  border: 'rgba(55, 155, 125, .1)',
  bubbleIn: 'rgba(28, 60, 50, .82)',
  bubbleOut: 'linear-gradient(135deg, #22c55e 0%, #15803d 100%)',
